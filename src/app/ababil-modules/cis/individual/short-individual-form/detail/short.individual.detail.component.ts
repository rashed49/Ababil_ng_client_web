...
@Component({
    selector: 'short-individual-detail',
    templateUrl: './short.individual.detail.component.html',
    styleUrls: ['./short.individual.detail.component.scss']
})
export class ShortIndividualDetailComponent extends BaseComponent implements OnInit {
