...
@Component({
  selector: 'joint-customer',
  templateUrl: './joint.customer.component.html',
  styleUrls: ['./joint.customer.component.scss'],
})
export class JointCustomerComponent extends BaseComponent implements OnInit {
  imageApiUrl: string;
